...
echo -^> local-release quantum-script-extension-json
...
call :cmdX xyo-cc quantum-script-extension-json --archive-release-sha512 --version-file=source/quantum-script-extension-json.version.ini
