...
cmdX xyo-cc --mode=$ACTION @build/source/quantum-script-extension-json.static.compile
cmdX xyo-cc --mode=$ACTION @build/source/quantum-script-extension-json.dynamic.compile
