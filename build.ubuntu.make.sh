...
cmdX xyo-cc --mode=$ACTION @util/quantum-script-extension-json.static.compile.info
cmdX xyo-cc --mode=$ACTION @util/quantum-script-extension-json.dynamic.compile.info
